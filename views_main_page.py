...
class Main_Page():
    ...
    def __init__(self) -> None:
        ...
        # Setting up the geometry for the main app and setting the location to the center of the app  : 
        self.x_location  = self.mainpage.winfo_screenwidth() // 2 + 450
        self.y_location  = self.mainpage.winfo_screenheight() // 2 + 300
        self.mainpage.geometry("900x600+{self.x_location}+{self.y_location}")
