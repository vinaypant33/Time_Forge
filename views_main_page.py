...
class Main_Page():
    ...
    def __init__(self , master , height  , width ) -> None:
        ...
        # sidebar
        self.sidebar = tk.Frame(self.main_page , height=900 , width=160 , background=colors.sidebar)
        ...
        self.seperator_frame = tk.Frame(self.sidebar , background="red")
        self.separator  = tk.Frame(self.seperator_frame , height=1 )
        ...
        self.dashboard_button  = ctk.CTkButton(self.sidebar , text="Dashboard" , image=self.white_home , corner_radius=0 , fg_color=colors.sidebar , hover_color=colors.pinkish_color  , compound="left")
        self.timesheet_button = ctk.CTkButton(self.sidebar , text="Timesheet" , image=self.timesheet_image , corner_radius=0 , fg_color=colors.sidebar , hover_color=colors.pinkish_color ,compound="left")
        self.todo_button  = ctk.CTkButton(self.sidebar , text="Todo           " , image=self.todo_image , corner_radius=0 , fg_color=colors.sidebar  , hover_color=colors.pinkish_color , compound="left")
        ...
        self.notification_button = tk.Button(self.bottom_frame ,text="🔔" , relief="flat" , bd= 0 )
        self.settings_button  =tk.Button(self.bottom_frame , text="⚙️" , relief="flat" , bd = 0)
        ...
        self.seperator_frame.pack(fill="x" , pady=10)
        ...
        self.notification_button.grid(row = 0 , column=0)
